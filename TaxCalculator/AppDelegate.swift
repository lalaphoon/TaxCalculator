...
//self-defined functions=========================================================
    ...
    func setUpFont(){
        ...
        UITextView.appearance().font = UIFont(name: SMALLTITLE, size: 18)
         ...
         UIBarButtonItem.appearance(whenContainedInInstancesOf: [UISearchBar.self]).setTitleTextAttributes([NSFontAttributeName : UIFont(name: SMALLTITLE, size: 15)!], for: UIControlState())
    
    }
    func dotsOnPagesSettings(){
        let pageController = UIPageControl.appearance()
        //pageController.pageIndicatorTintColor = UIColor.lightGrayColor()
        pageController.pageIndicatorTintColor = UIColor.orange
    ...
    func firstLaunchCheck() {
       //reference: http://www.jianshu.com/p/024dd2d6e6e6
        ...
        if appVersion == nil || appVersion != currentAppVersion {
            ...
            let guideViewController = storyboard.instantiateViewController(withIdentifier: "ParentOnboardingPagesViewController") as! ParentOnboardingPagesViewController
 ...
 //=====================================================================================
    ...
    lazy var applicationDocumentsDirectory: URL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "wtctax.TaxCalculator" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "TaxCalculator", withExtension: "momd")!
