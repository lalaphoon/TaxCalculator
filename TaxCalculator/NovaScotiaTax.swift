...
import Foundation
class NovaScotiaTax : ProvincialTax{
    var TP = TaxPro()
    var location = Location.Nova_Scotia
    let profileProvince : String = Location.Nova_Scotia.rawValue
    var BasicReduction_BaseAmount : Double = 15000
    var BasicReduction_Percentage : Double  = 0.05
    var BasicReduction_Threshold : Double = 300 //This one will be written in TP.BasicReduction
