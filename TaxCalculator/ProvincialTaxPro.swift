...
protocol ProvincialTax {
    ...
    func getForeignTaxCredit(income: Double, _ foreignIncome: Double, _ Deduction_2012 : Double, _ Deduction_2011 : Double, _ FederalForeignTaxCredit: Double, _ ProvincialForeignTaxCredit: Double, _ mode: Location,  _ extraDividendProvincial : Double , _extraDividendProvincial : Double  ) -> Double
